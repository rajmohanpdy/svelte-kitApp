...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-624616a5.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-624616a5.js", assets + "/_app/chunks/vendor-836cc791.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-178c7c76.js", "css": ["assets/pages/__layout.svelte-1fda6867.css"], "js": ["pages/__layout.svelte-178c7c76.js", "chunks/vendor-836cc791.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-6bd1dad9.js", "css": [], "js": ["error.svelte-6bd1dad9.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-4d888c4f.js", "css": ["assets/pages/index.svelte-b6f83df6.css"], "js": ["pages/index.svelte-4d888c4f.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-bc3f7811.js", "css": ["assets/pages/contact.svelte-4ef482ce.css"], "js": ["pages/contact.svelte-bc3f7811.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-9ab13a57.js", "css": ["assets/pages/contact.svelte-4ef482ce.css"], "js": ["pages/about.svelte-9ab13a57.js", "chunks/vendor-836cc791.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-bf66a07f.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-bf66a07f.js", "chunks/vendor-836cc791.js"], "styles": [] } };
  ...
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-t2wq17"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Home</a></li>
			...
			<li class="${["svelte-t2wq17", $page.path === "/contact" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/contact"}" class="${"svelte-t2wq17"}">Contact</a></li></ul>
...
<div class="${"content svelte-cf77e8"}"><h1>contact this app app</h1>

	<p>This is a <a href="${"https://kit.svelte.dev"}">SvelteKit</a> app. You can make your own by typing the following into your command line and following the prompts:
	</p>
